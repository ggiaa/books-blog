        ...
        <div class="col-md-6">
            <div class="card mb-3" style="margin-right: 1px">
                <div class="row g-0"> 
                    ...
                    <div class="col-md-8">                        
                        <div class="card-body">
                            <strong class="d-inline-block mb-3 text-danger">{{ $book->genre->category->name_category }}</strong> / <strong class="d-inline-block mb-3 text-danger"><a href="/genre/{{ $book->genre->slug_name }}">{{ $book->genre->genre_name }}</a></strong>                            
